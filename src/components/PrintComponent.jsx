...
const ComponentToPrint = ({ propsRef, data }) => {
  ...
  const dusun = addressTemp[3];
  const kelurahan = addressTemp[4];
  const kecamatan = addressTemp[5];
  const kodepos = addressTemp[6];
  const lintang = addressTemp[7];
  const bujur = addressTemp[8];
  const hours = timeToSchoolTemp[0];
  const minute = timeToSchoolTemp[1];
  const receivedKip = kipTemp[0];
  const reasonKip = kipTemp[1];
  ...
  return (
    <div style={tabStyle}>
      <div ref={propsRef} className="grid grid-cols-1 gap-1 px-8">
        ...
        <div className="printElement1 mb-[4rem]">
          ...
          <ul className="text-left flex flex-col gap-1">
            ...
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
              ...
              <span className="text-left whitespace-nowrap ">: {religion}</span>
            </li>
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
            ...
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
              ...
              <span className="text-left whitespace-nowrap ">: {dusun}</span>
            </li>
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
            ...
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
              ...
              <span className="text-left whitespace-nowrap ">: {kodepos}</span>
            </li>
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
              <span className="">Lintang </span>
              <span className="text-left whitespace-nowrap ">: {lintang}</span>
            </li>
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
        ...
        <div className="printElement1 mb-[1rem] mt-[2rem]">
        ...
        <div className="printElement1 mt-[2.5rem]">
          <h2 className="font-bold text-[1.2rem] mb-[0.5rem] ">
            Data Beasiswa
          </h2>
            ...
            return (
              <ul className="text-left flex flex-col gap-1 mb-[1rem]">
                <li className="font-semibold">
                  Beasiswa {data?.scholarship.length <= 1 ? "" : index + 1}
                </li>
        ...
        <div className="printElement1 mb-[1rem]">
          ...
          {data?.achievement.map((item, index) => {
            return (
              <ul className="text-left flex flex-col gap-1 mb-[1rem]">
                <li className="font-semibold">
                  Prestasi {data?.achievement.length <= 1 ? "" : index + 1}
                </li>
        ...
        <div className="printElement1 mb-[1rem]">
          ...
          <ul className="text-left flex flex-col gap-1">
            ...
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
              ...
              <span className="text-left whitespace-nowrap ">: {uniform1}</span>
            </li>
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
              <span className="">Baju Wear Pack </span>
              <span className="text-left whitespace-nowrap ">: {uniform2}</span>
            </li>
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
              <span className="">Baju Kotak-Kotak </span>
              <span className="text-left whitespace-nowrap ">: {uniform3}</span>
            </li>
            <li className="grid grid-cols-2 gap-4 w-[25rem] ">
              <span className="">Jaz Alamamater</span>
              <span className="text-left whitespace-nowrap ">: {uniform4}</span>
            </li>
          </ul>
        </div>
      </div>
